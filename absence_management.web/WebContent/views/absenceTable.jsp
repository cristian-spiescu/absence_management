		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<table class="table table-bordered table-striped">
					...
					%>
					<tr>
						<td><%=absence.getEmp().getFirstName()%></td>
						<td><%=absence.getEmp().getLastName()%></td>
						<td><%=absence.getDate_start()%></td>
						<td><%=absence.getDate_end() %></td>
						<td><%=absence.getTypeAbs().getTypeAbsence() %></td>
